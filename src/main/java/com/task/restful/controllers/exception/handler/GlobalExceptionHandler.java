...
public class GlobalExceptionHandler {
    ...
    public ResultVo handlerBadRequestException(HttpServletRequest request, BadRequestException ex) {
        return new ResultVo(ex);
    }

    @ExceptionHandler(Exception.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResultVo handlerInternalServerException(HttpServletRequest request, Exception ex) {
        ex.printStackTrace();
